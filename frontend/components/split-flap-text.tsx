...
function SplitFlapChar({ char, index, animationKey, skipEntrance, speed, playClick }: SplitFlapCharProps) {
  ...
  const bgColor = isSettled ? "#0a0a0c" : "rgba(253, 82, 153, 0.2)"
  const textColor = isSettled ? "#f2f2f4" : "#FD5299"
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden flex items-center justify-center font-[family-name:var(--font-bebas,var(--font-geist-sans))]"
      style={{
        fontSize: "clamp(4rem, 15vw, 14rem)",
        width: "0.65em",
        height: "1.05em",
