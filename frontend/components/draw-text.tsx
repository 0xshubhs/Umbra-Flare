  ...
  return (
    <h1
      ...
      style={{
        ...
        fontFamily: "var(--font-bebas, 'Bebas Neue'), var(--font-geist-sans), sans-serif",
        display: "flex",
        cursor: "pointer",
      }}
    >
      {characters.map((char, index) => (
        <span
          ...
          style={{
            backgroundColor: activeIndices[index] ? "#FD5299" : "transparent",
            color: activeIndices[index] ? "#0a0a0c" : flippingIndices[index] ? "#FD5299" : "transparent",
